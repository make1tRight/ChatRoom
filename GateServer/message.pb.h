...
class RplyFriendRsp PROTOBUF_FINAL :
 ...
 public:
  ...
  void clear_rplyuid();
  bool rplyuid() const;
  void set_rplyuid(bool value);
  private:
  bool _internal_rplyuid() const;
  void _internal_set_rplyuid(bool value);
  public:
...
class TextChatData PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_msgcontent();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_msgcontent(
...
inline bool RplyFriendRsp::_internal_rplyuid() const {
  return rplyuid_;
}
inline bool RplyFriendRsp::rplyuid() const {
  // @@protoc_insertion_point(field_get:message.RplyFriendRsp.rplyuid)
  return _internal_rplyuid();
}
inline void RplyFriendRsp::_internal_set_rplyuid(bool value) {
  
  rplyuid_ = value;
}
inline void RplyFriendRsp::set_rplyuid(bool value) {
  _internal_set_rplyuid(value);
...
inline std::string* TextChatData::unsafe_arena_release_msgid() {
  // @@protoc_insertion_point(field_unsafe_arena_release:message.TextChatData.msgid)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return msgid_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TextChatData::unsafe_arena_set_allocated_msgid(
    std::string* msgid) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (msgid != nullptr) {
  ...
  msgid_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      msgid, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:message.TextChatData.msgid)
}
...
inline std::string* TextChatData::unsafe_arena_release_msgcontent() {
  // @@protoc_insertion_point(field_unsafe_arena_release:message.TextChatData.msgcontent)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return msgcontent_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TextChatData::unsafe_arena_set_allocated_msgcontent(
    std::string* msgcontent) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (msgcontent != nullptr) {
  ...
  msgcontent_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      msgcontent, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:message.TextChatData.msgcontent)
}
